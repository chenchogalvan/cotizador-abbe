...
<html lang="en">
  ...
  <body>
    ...
    <p style="font-size: 20px; margin-top:50px;">Estimado <strong>{{ $totales[0]->nombre }}</strong>, la presente proyección se calcula con una tasa del <strong>{{ $totales[0]->tazaInteres }}</strong> anual fija para fines informativos. <br>La tasa de interés podrá ajustarse de acuerdo al análisis de riesgos.<br>Está información fue enviada por correo electronico al/los correo/s puesto/s en el formulario</strong>.</p>
